...
- [ ] unit listings, make it extremely easy for client to book appoinments, request call back, secure unit with deposit, give needed info upfront with the option to view all info
- [ ] add button to listings only visibile to sales, so when they go over inventory with sales staff they can just click create unit file, then displays a command dialog to select a client or create a new one
- [ ] button for client to leave deposit 
