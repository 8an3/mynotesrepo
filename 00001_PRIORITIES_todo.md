...
- [x] CFW - called steph, hes interested in getting it for his shop
...
- [x] CLIENT FACING WEBSITE -  unit listings, make it extremely easy for client to book appoinments, request call back, secure unit with deposit, give needed info upfront with the option to view all info
